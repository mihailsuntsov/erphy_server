...
class SpravBoxofficeController {
    ...
    public ResponseEntity<?> updateBoxoffice(@RequestBody SpravBoxofficeForm request){
        ...
        catch (Exception e){e.printStackTrace();e.printStackTrace();logger.error("Contrloller updateBoxoffice error", e);
    ...
    public  ResponseEntity<?> deleteBoxoffice(@RequestBody SignUpForm request) {
        ...
        catch (Exception e){e.printStackTrace();e.printStackTrace();logger.error("Contrloller deleteBoxoffice error", e);
    ...
    public  ResponseEntity<?> undeleteBoxoffice(@RequestBody SignUpForm request) {
        ...
        catch (Exception e){e.printStackTrace();e.printStackTrace();logger.error("Contrloller undeleteBoxoffice error", e);
