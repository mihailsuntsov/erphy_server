...
import com.dokio.model.Sprav.SpravSysPriceRoleJSON;
...
public class SpravSysPriceRoleController {
    Logger logger = Logger.getLogger("SpravSysPriceRoleController");
    ...
    public ResponseEntity<?> getSpravSysPriceRole() {
        logger.info("Processing post request for path /api/auth/getSpravSysPriceRole");
