...
public class AuthRestAPIs {
	...
	public Set<Long> getAdminPermissions(){
		return new HashSet<>(Arrays.asList(6L,8L, 3L, 4L, 18L, 19L, 25L, 27L, 22L, 23L, 26L, 17L, 14L, 16L, 11L, 12L, 28L, 29L, 34L, 31L, 32L, 90L, 93L, 94L, 95L, 97L, 108L, 111L, 113L, 113L, 115L, 117L,
				...
				636L, 638L, 640L, 642L, 238L, 239L, 242L, 112L, 644L, 645L, 647L, 649L, 651L, 653L, 654L, 656L, 658L, 660L, 662L, 663L, 665L, 667L, 669L, 671L, 672L, 674L, 676L, 678L));
	}
