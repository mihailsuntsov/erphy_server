...
public class OrdersupProductTableForm {

    private Long product_id;
    private Long ordersup_id;
    ...
    public Long getOrdersup_id() {
        return ordersup_id;
    }

    public void setOrdersup_id(Long ordersup_id) {
        this.ordersup_id = ordersup_id;
    }
