...
public class SettingsCalendarJSON {
    ...
    public SettingsCalendarJSON() {
    }

    public SettingsCalendarJSON(String startView, int timelineStep, int dayStartMinute, int dayEndMinute, String resourcesScreenScale, Boolean displayCancelled) {
