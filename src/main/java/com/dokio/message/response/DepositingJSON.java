...
public class DepositingJSON {
    ...
    private String      boxoffice;    // касса предприятия, из которой будет производиться внесение
    ...
    private Long        boxoffice_id;    // id кассы предприятия, из которой будет производиться внесение

    private Long        orderout_id;    // id расходного ордера, которым будет производиться внесение
    private String      orderout;    // расходный ордер, которым будет производиться внесение
