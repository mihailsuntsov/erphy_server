                    ...
                    DocumentMasterId.equals(myMasterId))
            {
                ...
                try{
                    ...
                    if(insertShipmentProducts(request, newDocId, myMasterId)){
                        ...
                        if (request.getLinked_doc_id() != null) {
                            linkedDocsUtilites.addDocsToGroupAndLinkDocs(request.getLinked_doc_id(), newDocId, linkedDocsGroupId, request.getParent_uid(),request.getChild_uid(),request.getLinked_doc_name(), "shipment", request.getCompany_id(), myMasterId);
                        }
                        return newDocId;
                    } else return null;
