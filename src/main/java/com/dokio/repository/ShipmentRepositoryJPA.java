    ...
    public Long insertShipment(ShipmentForm request) {
        if(commonUtilites.isDocumentUidUnical(request.getUid(), "shipment")){
                    ...
                    DocumentMasterId.equals(myMasterId))
            {
                ...
                stringQuery =   "insert into shipment (" +
                ...
                try{
                    ...
                    if(insertShipmentProducts(request, newDockId, myMasterId)){
                        ...
                        if (request.getLinked_doc_id() != null) {
                            linkedDocsUtilites.addDocsToGroupAndLinkDocs(request.getLinked_doc_id(), newDockId, linkedDocsGroupId, request.getParent_uid(),request.getChild_uid(),request.getLinked_doc_name(), "shipment", request.getCompany_id(), myMasterId);
                        }
                        return newDockId;
                    } else return null;
...
//            throw new CantInsertProductRowCauseOversellException();
    ...
    @Transactional
    @SuppressWarnings("Duplicates")
    public DeleteDocksReport deleteShipment (String delNumbers) {
