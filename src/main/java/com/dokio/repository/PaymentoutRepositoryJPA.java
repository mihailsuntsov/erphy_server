        ...
        try {
            stringQuery =
                    " insert into settings_paymentout (" +
                            ...
                            ") " +
                            " ON CONFLICT ON CONSTRAINT settings_paymentout_user_id_key " +// "upsert"
                            " DO update set " +
...
//*****************************************************************************************************************************************************
    ...
    public List<PaymentoutJSON> getPaymentoutList(Long account_id,Long recipient_id) {
        ...
        stringQuery = "select  p.id as id, " +
                ...
                "           and ((p.moving_type='boxoffice' and p.boxoffice_to_id=:recipient_id) or (p.moving_type='account' and p.payment_account_to_id=:recipient_id))" +
