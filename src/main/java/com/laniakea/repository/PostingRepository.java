...
import com.laniakea.message.request.PostingForm;
import com.laniakea.message.request.PostingProductForm;
import com.laniakea.message.request.SearchForm;
import com.laniakea.message.request.UniversalForm;
import com.laniakea.message.response.PostingJSON;
import com.laniakea.message.response.FilesPostingJSON;
...
//*****************************************************************************************************************************************************
    ...
    public List<FilesPostingJSON> getListOfPostingFiles(Long postingId) {
        if(securityRepositoryJPA.userHasPermissions_OR(16L, "207,208"))//Просмотр документов
        {
