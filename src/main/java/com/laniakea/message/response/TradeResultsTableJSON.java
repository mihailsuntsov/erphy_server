...
@Entity
public class TradeResultsTableJSON {
    ...
    private String trade_date_char;
    ...
    public String getTrade_date_char() {
        return trade_date_char;
    }

    public void setTrade_date_char(String trade_date_char) {
        this.trade_date_char = trade_date_char;
    }
