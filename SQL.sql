...
(600,'Отчёт "Чистая прибыль" - просмотр по всем предприятиям','Возможность построения отчёта по приходу и расходу по всем предприятиям','Стартовая страница',26),
(601,'Отчёт "Чистая прибыль" - просмотр по своему предприятию','Возможность построения отчёта по приходу и расходу по своему предприятию','Стартовая страница',26),
